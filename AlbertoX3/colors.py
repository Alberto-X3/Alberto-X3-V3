...
_color_data_flat_ui = safe_load(
    __root__.joinpath("colors/flat_ui.yml").read_text("utf-8")
)
_color_data_material = safe_load(
    __root__.joinpath("colors/material.yml").read_text("utf-8")
)
